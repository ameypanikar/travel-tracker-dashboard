import { Plane, Hotel, Sun, Car, CalendarDays, UtensilsCrossed, TrainFront, CalendarCheck } from "lucide-react";

export type TabKey = "flights" | "hotels" | "trains" | "day" | "monthly" | "uber" | "eats" | "events";
